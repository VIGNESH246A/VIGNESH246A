...
#### 🧠 GenAgent Pro - Agentic Workflow Engine
**Production-grade multi-agent system with autonomous task execution**

**Tech Stack:** LangGraph • Gemini • FAISS • Tool Calling  
**Highlights:**
...
#### 👔 HR Copilot - AI Hiring Assistant
**Autonomous HR system with intelligent workflow management**

**Tech Stack:** Google Gemini • LangChain • Streamlit  
**Highlights:**
- Natural language task management
- Automated JD generation & resume screening
- Interview scheduling with email automation
- Analytics dashboard with hiring metrics
- Context-aware conversation memory

🔗 [Live Demo](https://hr-copilot-2egdggstbugtejcanhzcnu.streamlit.app/) | 📂 [Repository](https://github.com/VIGNESH246A/HR-Copilot)
...
**Production-ready RAG system for internal knowledge search**

**Tech Stack:** FAISS • Gemini • FastAPI • Streamlit  
**Highlights:**
- Multi-format support (PDF, DOCX, TXT)
- Semantic search with citation grounding
...
#### 🏥 Policy & Invoice RAG System
**Enterprise-grade RAG with OCR and hallucination control**

**Tech Stack:** ChromaDB • Gemini • OCR • Streamlit  
**Highlights:**
- Multi-format OCR (PDF, images, DOCX)
- Advanced hallucination detection system
- Domain-specific filtering (finance/insurance)
...
**RAG-powered chatbot with actionable message detection**

**Tech Stack:** Random Forest • LSTM • RAG • Streamlit  
**Highlights:**
- Dual model classification (RF/LSTM)
- Actionable vs non-actionable routing
...
#### 🏏 Cricbuzz LiveStats
**Real-time cricket analytics with API integration**

**Tech Stack:** Python • SQL • REST API • Streamlit  
**Highlights:**
...
**Decade-long e-commerce trend analysis**
